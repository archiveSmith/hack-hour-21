...
function poker(hand1, hand2) {
    //have the rule specified in dictionary
    //have dictionary for each player
    //as iterating through each player's cards, determine which card pattern each has
    const rule = {1: '4-of-a-kind', 2: 'full house', 3: 'straight', 4: '3-of-a-kind', 5:'2-pair',6:'1-pair',7:'high card' }
    let player1 = {};
    let player2 = {};
